<template>
  <el-dialog
    ...
    <el-form :model="dataForm" :rules="dataRule" ref="dataForm" @keyup.enter.native="dataFormSubmit()" label-width="80px">
      ...
      <el-form-item id="parent" v-if="dataForm.type !== 0" label="上级菜单" prop="parentName">
        <el-popover
          ref="menuListPopover"
        ...
        this.$http({
          ...
          if (!this.dataForm.id) {
            ...
            this.$http({
              ...
              console.log(data)
              console.log(data.data.isMenu)
              this.dataForm.id = data.data.menuId
              this.dataForm.type = data.data.isMenu === '1' ? 0 : 1
              this.dataForm.name = data.data.menuName
        ...
        this.$refs['dataForm'].validate((valid) => {
          if (valid) {
            this.$http({
              ...
              'isPage': this.dataForm.type === 1 ? '1' : '0',
              'isMenu': this.dataForm.type === 1 ? '0' : '1',
