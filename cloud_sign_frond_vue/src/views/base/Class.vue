    ...
    <div class="weui-tab">
      ...
      <div class="weui-tab__panel">
        ...
        <div class="weui-panel weui-panel_access">
          <div class="weui-panel__hd">我的班课</div>
          <div class="weui-panel__bd">
            <a
              ...
              v-bind:key="cla.id"
              @click="goMyclass(cla.id)"
            >
              <div class="weui-media-box__hd">
                <img class="weui-media-box__thumb" :src="cla.icon" alt="" />
              </div>
              <div class="weui-media-box__bd">
                <h4 class="weui-media-box__title">{{ cla.name }}</h4>
          ...
          <div class="weui-panel__ft" v-show="false">
            <a
              href="javascript:"
...
import { ClassInfo } from "@/types/model/Class";
...
export default class Class extends Vue {
  private index = 1;
  private classes: Array<ClassInfo> = [
    {
      id: 1,
      name: "神经计算网络及应用",
      descript:
